                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 md:gap-6">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg class="fill-black dark:fill-white/90" width="24" height="24"
                            ...
                            <div class="mt-5 flex items-end justify-between">
                                <div>
                                    ...
                                    <h4 class="mt-2 text-title-sm font-bold text-white dark:text-white/90">
                        ...
                        <div
                            ...
                            <div class="mt-5 flex items-end justify-between">
                                <div>
                                    ...
                                    <h4 class="mt-2 text-title-sm font-bold text-white dark:text-white">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg class="fill-gray-800 dark:fill-white/90" width="24" height="24"
                                    viewBox="-5 0 19 19" xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
                                    <path
                        ...
                        <div class="bg-blue-400 text-white rounded-lg shadow-lg p-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <img src="{{ asset($bestSellerMinuman->gambar) }}"
                                    alt="{{ $bestSellerMinuman->nama }}" class="w-16 h-16 rounded-lg object-cover">
                                <div>
